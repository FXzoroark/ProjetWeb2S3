...
class ProduitV1Controller extends AbstractController
{
    /**
    ...
    /**
     * @Route("/produit/edit/{id}", name="produit_edit", methods={"GET"})
     * @Route("/produit/edit", name="produit_edit_valid", methods={"PUT"})
     */
    public function editProduit(Request $request, $id=null)
    {
        ...
        if($request->getMethod() == 'GET'){
            ...
            return $this->render('admin/produit/editProduit.html.twig', ['typeProduits'=> $typeProduits, 'donnees' => $produit, 'dateLancement' => $dateLancement]);
        }
        ...
        $typeProduits=$this->getDoctrine()->getRepository(TypeProduit::class)->findBy([],['libelle'=>'ASC']);
        // fin A modifier
        return $this->render('admin/produit/editProduit.html.twig', ['donnees'=>$donnees,'erreurs'=>$erreurs,'typeProduits'=> $typeProduits]);
    }
